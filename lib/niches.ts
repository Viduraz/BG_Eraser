...
const niches: Record<string, NicheContent> = {
  ...
  "car-photos": {
    slug: "car-photos",
    title: "Car Photos",
    pageTitle: "Free AI Background Remover for Car Photos — BgEraser",
    metaDescription:
    ...
    intro:
      "Whether you are a private seller listing a vehicle on eBay Motors or AutoTrader, a franchised dealer managing hundreds of inventory images, or a photographer producing editorial auto content, clean background-free car photos are no longer optional — they are the industry standard. BgEraser removes backgrounds from car images with a single click, giving you professional, consistent results that make your listings stand out from the competition.",
    ...
    faq: [
      {
        ...
        a: "Yes. BgEraser works on car photos taken in any environment — driveways, car parks, roads, or indoor showrooms. The AI identifies the vehicle outline regardless of what surrounds it.",
      },
      {
      ...
      },
      {
        ...
        a: "Currently, BgEraser processes one image at a time. For high-volume batch processing, we recommend using our tool for spot checks and quality verification, while contacting us about API access for automated workflows.",
      },
    ],
  },
  ...
  "real-estate": {
    ...
    pageTitle: "Background Remover for Real Estate Photos — BgEraser",
    metaDescription:
    ...
    intro:
      "In the US real estate market, where agents compete for every listing and buyers make split-second judgments based on online photos, professional imagery is not a luxury — it is a prerequisite. BgEraser gives real estate agents, brokers, and property photographers instant access to AI-powered background removal, transforming ordinary photos into polished, marketing-ready assets without a Photoshop subscription or a visit to a photography studio.",
    ...
    faq: [
      {
        ...
        a: "Yes. BgEraser works on any image type, including interior architectural photos, exterior property shots, and garden/landscape images.",
      },
      {
  ...
  "id-cards": {
    ...
    pageTitle: "Background Remover for ID Cards & Passport Photos — BgEraser",
    metaDescription:
    ...
    faq: [
      {
        ...
        a: "BgEraser produces a transparent PNG with accurate background removal. You must then add a white background and crop to 2×2 inches at 600dpi. This meets the US State Department's published technical requirements.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. BgEraser works on portrait photos of people of all ages. Ensure the child's face is clearly visible and well-lit for best results.",
      },
    ],
  },
  ...
  "product-photos": {
    ...
    pageTitle: "Free AI Background Remover for Product Photos — BgEraser",
    metaDescription:
    ...
    intro:
      "Amazon's image guidelines require a pure white background (RGB 255, 255, 255) for main product images. Etsy, Shopify, eBay, and most other e-commerce platforms strongly recommend it. Professional product photography studios in the US and UK charge $25–$100 per image for this service. BgEraser gives you the same result for free, in seconds, running entirely in your browser.",

    sections: [
      {
        heading: "Amazon Main Image Requirements and Why They Matter",
        body: "Amazon mandates that the main (hero) image for every product listing must feature the product on a pure white background with no props, text, logos, or additional objects. Products that violate this policy have their listings suppressed — removed from search results entirely until the image is corrected. For sellers managing hundreds of SKUs, ensuring every main image meets this standard is a significant operational challenge. Professional product photography services are expensive and slow; in-house photography requires a lightbox studio setup and post-production editing skills. BgEraser eliminates both constraints. Any seller can photograph their product on any surface — a table, a piece of card, outdoors — and use BgEraser to produce an Amazon-compliant white-background image in under a minute. The AI handles complex product shapes accurately: jewellery with intricate detail, clothing with complex silhouettes, electronics with cables and USB ports, and glassware with transparent elements.",
      },
      {
        heading: "Etsy, Shopify, and Social Commerce Product Imagery",
        body: "While Amazon's white background requirement is mandatory, Etsy and Shopify sellers have more creative flexibility — but background-free product images are still the professional standard. Clean, consistent product images allow buyers to compare items clearly, build basket-ready flat-lay compositions in design tools, and create matching social media content. Instagram Shopping, Pinterest Shopping, and TikTok Shop all benefit from consistent, background-free product imagery that can be placed on branded colour backgrounds matching a shop's visual identity. BgEraser's transparent PNG output integrates directly with Canva, where sellers can then apply their brand colours, add product descriptions as graphics, or create collection shots by compositing multiple products on a single background. For Shopify stores using the Dawn or Debut theme, transparent PNGs also render correctly on the page's background colour without unwanted white boxes — a subtle but professionally important distinction.",
      },
      {
        heading: "Handling Challenging Product Types: Transparent, Reflective, and Fine Detail",
        body: "Product photography background removal is technically demanding. Jewellery features fine chains and intricate metalwork where individual links are only a few pixels wide. Glassware and bottles are partially transparent — a glass jar against a white background has almost no edge contrast for a colour-based segmentation algorithm to detect. Clothing has complex fabric textures, folds, and shadows. Shoes have detailed stitching, lace holes, and often complex sole designs. BgEraser's neural network has been trained on millions of product images across all major categories, making it significantly more accurate on product shots than general-purpose background removal tools. For truly challenging items — ultra-fine jewellery chains, completely transparent glassware — we recommend shooting against a mid-grey background to provide sufficient edge contrast for the AI, then using BgEraser to remove that background cleanly.",
      },
      {
        heading: "Cost Savings and Workflow Integration for E-Commerce Brands",
        body: "For a US or UK e-commerce business with a 500 SKU catalogue, professional background removal at $25 per image represents a $12,500 line item — plus the time cost of briefing a studio, reviewing proofs, and managing revisions. BgEraser eliminates this cost entirely. For growing brands that photograph new products weekly, the savings compound significantly. The tool integrates into any existing workflow: photograph products with your iPhone or a DSLR, import the photos to your laptop, drag-and-drop through BgEraser, download the transparent PNGs, and upload directly to your Shopify backend or Amazon Seller Central. No subscription, no monthly fee, no per-image charge. The only requirement is a modern web browser.",
      },
    ],
    ...
    faq: [
      {
        ...
        a: "BgEraser removes the background to full transparency. When you add a white background in Canva or any image editor, you control the exact white value. Set it to RGB 255,255,255 and export as JPEG for Amazon compliance.",
      },
      {
        q: "Can it handle glassware and transparent product photos?",
        a: "Yes, though results vary. For best results with transparent products, photograph against a mid-grey background to give the AI clear edge contrast. Then use BgEraser to remove that grey cleanly.",
      },
      {
        q: "What file size limit does BgEraser support?",
        a: "BgEraser supports image files up to 20 MB. For product photography, this covers virtually all phone and DSLR raw exports.",
      },
    ],
  },
  ...
  "profile-photos": {
    ...
    pageTitle: "Free Background Remover for Profile Photos & Headshots — BgEraser",
    metaDescription:
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. BgEraser is trained specifically on diverse portrait imagery including curly, afro, loose, and flyaway hair types. Results are significantly more accurate than general-purpose tools for complex hair.",
      },
      {
...
export function getGenericNiche(slug: string): NicheContent {
  ...
  return {
    slug,
    title,
    pageTitle: `Free AI Background Remover for ${title} — BgEraser`,
    ...
    faq: [
      ...
      {
        q: "What image formats does BgEraser support?",
        a: "BgEraser supports JPEG, PNG, and WEBP images up to 20 MB in file size.",
      },
    ],
  };
}
